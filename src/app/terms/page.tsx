      ...
      <div className="legal-body">
        ...
        <div className="legal-section">
          ...
          <ul className="legal-ul">
            ...
            <li>投稿コンテンツの著作権はユーザーに帰属します。ユーザーは、当サービスの提供・改善・紹介（サービス画面での表示等）に必要な範囲に限り、運営に対し非独占的かつ無償で当該コンテンツの利用を許諾するものとします。</li>
        ...
        <div className="legal-section">
          ...
          <p className="legal-p">
            対面での約束・金銭の貸し借り・スタジオ代の精算など、ユーザー間で生じたトラブルや紛争については、当事者間で解決するものとし、運営は仲裁・介入の義務を負わないものとします。
          </p>
        </div>
        ...
        <div className="legal-section">
          ...
          <p className="legal-p">
            運営は、当サービスの利用によってユーザーに生じた損害について、運営の故意または重大な過失による場合を除き、一切の責任を負わないものとします。ただし、消費者契約法その他の法令により免責が認められない場合はこの限りではありません。運営は、当サービスの内容変更・中断・終了、データの消失等について、事前に通知のうえ実施する場合があります。
          </p>
        </div>
        ...
        <div className="legal-section">
          ...
          <p className="legal-p">
            本規約の解釈にあたっては日本法を準拠法とします。当サービスに関して紛争が生じた場合には、奈良地方裁判所を第一審の専属的合意管轄裁判所とします。
          </p>
        </div>
